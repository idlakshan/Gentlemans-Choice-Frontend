...
import { useFetchProductByIdQuery, useUpdateProductMutation } from '../../../../redux/features/product/productApi';
...
const UpdateProduct = () => {
    ...
    const [updateProduct, { isLoading: loading, isError: productError }] = useUpdateProductMutation();
