                                    ...
                                    p-2 mb-4'>
                                        <div className='flex items-center'>
                                            ...
                                            <div className='flex flex-row md:justify-start justify-end items-center mt-2'>
                                                <button className='size-9 flex justify-center items-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white ml-8'
                                                    onClick={() => handleQuantity("decrement", product._id)}>-</button>
                                                <span className='px-2 text-center ml-1'>{product.quantity}</span>
                                                <button className='size-9 flex justify-center items-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white'
                                                    onClick={() => handleQuantity("increment", product._id)}>+</button>

                                                <div className='ml-5'>
                                                    <button onClick={(e)=>handleRemove(e,product._id)} className='text-red-500 hover:text-red-800 mr-4'>Remove</button>
                                                </div>
